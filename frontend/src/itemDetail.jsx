          ...
          <div>
            {isEditing ? (
              ...
              <div className="flex items-center gap-3">
                <span className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Gifted?</span>
                <span className={`text-sm ${(item.gifted === 'true' || item.gifted === true) ? 'text-green-700 dark:text-green-400' : 'text-neutral-600 dark:text-neutral-400'}`}>
                  {(item.gifted === 'true' || item.gifted === true) ? 'Yes, this is a gift' : 'Not a gift'}
                </span>
              </div>
            )}
          </div>
